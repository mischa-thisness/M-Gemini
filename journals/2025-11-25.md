...
> * Install called
> * Windows win32
> * Choco, winget found, the package hunt, ahoy!
> * Choco first, then winget's might
> * Package search, to bring the app to light
> * LatencyMon, please grace this box with sight
> * Install starts!
> * Chocolatey finds it, flag set to yes
> * Sudo? Fail!
> * Winget called
> * Let's try it now.
> * Install hope.
