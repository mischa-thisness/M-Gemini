...
*   **Architectural Decisions:**
    *   Leveraged PowerShell for system analysis due to CLI limitations.
    *   Focused on streamlining data gathering for a broad service overview.
    *   Prioritized running services for reporting.
    *   Addressed service dependencies by focusing on specific services like `MullvadVPN` and `WinDefend`.
*   **Bugs/Fixes:**
    *   No bugs explicitly fixed, but streamlining efforts addressed potential performance issues.
*   **New Features/Scripts:**
    *   Implemented PowerShell scripts to:
        *   List startup applications.
        *   Inventory and verify the operational status of services.
        *   Map service dependencies.
        *   Analyze service resource usage (CPU, memory).
        *   Scan system event logs for service-related errors.
*   **Tools/Libraries:**
    *   PowerShell: `Get-CimInstance`, `Get-Service`, `Get-Process`, `Get-EventLog`, `Select-Object`, `Format-Table`.
